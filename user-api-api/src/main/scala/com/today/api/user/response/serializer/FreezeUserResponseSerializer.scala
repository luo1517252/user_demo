 package com.today.api.user.response.serializer;
        ...
        **/
        ...
        class FreezeUserResponseSerializer extends TCommonBeanSerializer[com.today.api.user.response.FreezeUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today.api.user.response.FreezeUserResponse = {
      ...
      val bean = com.today.api.user.response.FreezeUserResponse(userId = userId,status = status,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today.api.user.response.FreezeUserResponse, oprot: TProtocol): Unit = {
      ...
      @throws[TException]
      override def validate(bean: com.today.api.user.response.FreezeUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today.api.user.response.FreezeUserResponse): String = if (bean == null) "null" else bean.toString
