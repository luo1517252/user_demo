 package com.today.api.user.request.serializer;
        ...
        **/
        ...
        class BlackUserRequestSerializer extends TCommonBeanSerializer[com.today.api.user.request.BlackUserRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today.api.user.request.BlackUserRequest = {
      ...
      val bean = com.today.api.user.request.BlackUserRequest(userId = userId,remark = remark)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today.api.user.request.BlackUserRequest, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("BlackUserRequest"))
      ...
      override def validate(bean: com.today.api.user.request.BlackUserRequest): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today.api.user.request.BlackUserRequest): String = if (bean == null) "null" else bean.toString
