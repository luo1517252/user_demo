 package com.today.api.user.response.serializer;
        ...
        **/
        ...
        class ModifyUserResponseSerializer extends TCommonBeanSerializer[com.today.api.user.response.ModifyUserResponse]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today.api.user.response.ModifyUserResponse = {
      ...
      val bean = com.today.api.user.response.ModifyUserResponse(userName = userName,telephone = telephone,status = status,email = email,qq = qq,updatedAt = updatedAt)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today.api.user.response.ModifyUserResponse, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("ModifyUserResponse"))
      ...
      @throws[TException]
      override def validate(bean: com.today.api.user.response.ModifyUserResponse): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today.api.user.response.ModifyUserResponse): String = if (bean == null) "null" else bean.toString
