 package com.today.api.user.request.serializer;
        ...
        **/
        ...
        class RegisterUserRequestSerializer extends TCommonBeanSerializer[com.today.api.user.request.RegisterUserRequest]{
          
      @throws[TException]
      override def read(iprot: TProtocol): com.today.api.user.request.RegisterUserRequest = {
      ...
      val bean = com.today.api.user.request.RegisterUserRequest(userName = userName,passWord = passWord,telephone = telephone)
      validate(bean)
      ...
      @throws[TException]
      override def write(bean: com.today.api.user.request.RegisterUserRequest, oprot: TProtocol): Unit = {

      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("RegisterUserRequest"))
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("passWord", com.isuwang.org.apache.thrift.protocol.TType.STRING, 2.asInstanceOf[Short]))
      ...
      @throws[TException]
      override def validate(bean: com.today.api.user.request.RegisterUserRequest): Unit = {
          ...
          @throws[TException]
          override def toString(bean: com.today.api.user.request.RegisterUserRequest): String = if (bean == null) "null" else bean.toString
