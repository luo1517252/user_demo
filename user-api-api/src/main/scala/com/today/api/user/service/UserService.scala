 ...
 *  @generated
        ...
        * 
        **/
        @Service(name ="com.today.api.user.service.UserService" , version = "1.0.0")
        @Processor(className = "com.today.api.user.UserServiceCodec$Processor")
        trait UserService {
...
####  输出
    1.user_response.RegisterUserResponse
            ...
            **/
            ...
            def registerUser(
            request: com.today.api.user.request.RegisterUserRequest ): com.today.api.user.response.RegisterUserResponse
...
####  输出
    1.user_response.LoginUserResponse
            ...
            **/
            ...
            def login(
            request: com.today.api.user.request.LoginUserRequest ): com.today.api.user.response.LoginUserResponse
...
####  输出
    1.user_response.ModifyUserAction
            ...
            **/
            ...
            def modifyUser(
            request: com.today.api.user.request.ModifyUserRequest ): com.today.api.user.response.ModifyUserResponse
...
####  输出
    1.user_response.FreezeUserResponse
            ...
            **/
            ...
            def freezeUser(
            request: com.today.api.user.request.FreezeUserRequest ): com.today.api.user.response.FreezeUserResponse
...
####  输出
    1.user_response.BlackUserResponse
            ...
            **/
            ...
            def blackUser(
            request: com.today.api.user.request.BlackUserRequest ): com.today.api.user.response.BlackUserResponse
